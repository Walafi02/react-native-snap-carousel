...
import { I18nManager, Platform, View, ViewPropTypes, Platform } from 'react-native';
...
export default class Pagination extends PureComponent {
    ...
    static propTypes = {
        ...
        containerStyle: ViewPropTypes ? ViewPropTypes.style : Platform.OS !== 'web' ? View.propTypes.style : {},
        dotColor: PropTypes.string,
        dotContainerStyle: ViewPropTypes ? ViewPropTypes.style : Platform.OS !== 'web' ? View.propTypes.style : {},
        dotElement: PropTypes.element,
        dotStyle: ViewPropTypes ? ViewPropTypes.style : Platform.OS !== 'web' ? View.propTypes.style : {},
        inactiveDotColor: PropTypes.string,
        inactiveDotElement: PropTypes.element,
        inactiveDotOpacity: PropTypes.number,
        inactiveDotScale: PropTypes.number,
        inactiveDotStyle: ViewPropTypes ? ViewPropTypes.style : Platform.OS !== 'web' ? View.propTypes.style : {},
